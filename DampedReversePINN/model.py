...
class DamperConfig:
    ...
    lr_param: float = 0.00630957344480193   # learning rate for physical parameters (zeta_hat, w0_hat)
    ...
    # ── Output paths ──────────────────────────────────────────────────────────
    out_dir:    str = "./DampedReversePINN/Output"                  # directory for all saved files
