...
\end{tabular}
\end{table}
The training finished after 7200 epochs, which results in a time per epoch of $12.33$~ms. The RAM and VRAM usage as a function of time for the data generation is displayed below:
\begin{figure}[H]
    \centering
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
