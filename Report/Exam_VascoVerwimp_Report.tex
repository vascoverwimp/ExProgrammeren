...
\fancyhf{}
\rhead{\thepage}
\lhead{PINNs for Differential Equations}

% Title
\title{\textbf{Physics-Informed Neural Networks: Applications to Differential Equations}}
...
\begin{enumerate}
    ...
    \item \textbf{Automatic differentiation}: Use frameworks like PyTorch or TensorFlow to compute $\pd{u_\theta}{x}$, $\pd{u_\theta}{t}$, and higher-order derivatives.
